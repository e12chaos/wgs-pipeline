...
# Run bwa mem for BM002F_A_S3_L001
bwa mem -t 12 ../data/hg38.fa ../output/trim/BM002F_A_S3_L001_R1_001_paired.fastq.gz ../output/trim/BM002F_A_S3_L001_R2_001_paired.fastq.gz > ../output/alignment/BM002F_A_S3_L001.sam
