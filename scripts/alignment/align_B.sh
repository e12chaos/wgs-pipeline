...
bwa mem -t 12 ../data/hg38.fa ../output/trim/BM002B_A_S1_L001_R1_001_paired.fastq.gz ../output/trim/BM002B_A_S1_L001_R2_001_paired.fastq.gz > ../output/alignment/BM002B_A_S1_L001.sam
